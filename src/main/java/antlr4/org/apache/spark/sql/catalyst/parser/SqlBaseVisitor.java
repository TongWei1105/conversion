...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code mergeSmallFiles}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMergeSmallFiles(SqlBaseParser.MergeSmallFilesContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#defaultSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefaultSpec(SqlBaseParser.DefaultSpecContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#lifecycleSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLifecycleSpec(SqlBaseParser.LifecycleSpecContext ctx);
	/**
