...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code mergeSmallFiles}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterMergeSmallFiles(SqlBaseParser.MergeSmallFilesContext ctx);
	/**
	 * Exit a parse tree produced by the {@code mergeSmallFiles}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitMergeSmallFiles(SqlBaseParser.MergeSmallFilesContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#defaultSpec}.
	 * @param ctx the parse tree
	 */
	void enterDefaultSpec(SqlBaseParser.DefaultSpecContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#defaultSpec}.
	 * @param ctx the parse tree
	 */
	void exitDefaultSpec(SqlBaseParser.DefaultSpecContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#lifecycleSpec}.
	 * @param ctx the parse tree
	 */
	void enterLifecycleSpec(SqlBaseParser.LifecycleSpecContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#lifecycleSpec}.
	 * @param ctx the parse tree
	 */
	void exitLifecycleSpec(SqlBaseParser.LifecycleSpecContext ctx);
	/**
