...
statement
    ...
    | ALTER TABLE multipartIdentifier
        partitionSpec? MERGE SMALLFILES                                #mergeSmallFiles
...
relationPrimary
    : multipartIdentifier sample? tableAlias
      lateralView*                            #tableName
    | '(' query ')' sample? tableAlias
      lateralView*                            #aliasedQuery
...
colType
    : colName=errorCapturingIdentifier dataType defaultSpec? (NOT NULL)? commentSpec?
    ;
